<?php /* Smarty version 2.6.26, created on 2012-04-12 10:01:44
         compiled from widget/product/bargainitems.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxscript', 'widget/product/bargainitems.tpl', 1, false),array('function', 'oxmultilang', 'widget/product/bargainitems.tpl', 19, false),array('function', 'oxgetseourl', 'widget/product/bargainitems.tpl', 33, false),array('modifier', 'strip_tags', 'widget/product/bargainitems.tpl', 7, false),array('modifier', 'cat', 'widget/product/bargainitems.tpl', 33, false),array('block', 'oxhasrights', 'widget/product/bargainitems.tpl', 16, false),)), $this); ?>
...
">
                ...
                <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'SHOWARTICLEPRICE')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                    <?php if ($this->_tpl_vars['_product']->getFTPrice() > $this->_tpl_vars['_product']->getFPrice()): ?>
                    <span class="priceOld">
 ...
 <?php echo $this->_tpl_vars['_product']->oxarticles__oxunitname->value; ?>
