...
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxstyle', 'widget/promoslider.tpl', 4, false),array('function', 'oxscript', 'widget/promoslider.tpl', 5, false),)), $this); ?>
<?php $this->assign('oBanners', $this->_tpl_vars['oView']->getBanners()); ?>
<?php $this->assign('currency', $this->_tpl_vars['oView']->getActCurrency()); ?>
<?php if ($this->_tpl_vars['oBanners']): ?>
