...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'layout/sidebar.tpl', 53, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php if ($this->_tpl_vars['oView']->showTags() && $this->_tpl_vars['oView']->getClassName() != 'details' && $this->_tpl_vars['oView']->getClassName() != 'alist' && $this->_tpl_vars['oView']->getClassName() != 'tags'): ?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php if ($this->_tpl_vars['oView']->isActive('FbFacepile') && $this->_tpl_vars['oView']->isConnectedWithFb()): ?>
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/facebook/facepile.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
        <?php endif; ?>
