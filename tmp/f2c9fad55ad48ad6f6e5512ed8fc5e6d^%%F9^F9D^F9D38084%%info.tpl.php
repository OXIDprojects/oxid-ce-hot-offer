...
">
        <?php $this->assign('sTrustShopImg', ((is_array($_tmp=((is_array($_tmp='trustedshops_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['oViewConf']->getActLanguageId()) : smarty_modifier_cat($_tmp, $this->_tpl_vars['oViewConf']->getActLanguageId())))) ? $this->_run_mod_handler('cat', true, $_tmp, ".gif") : smarty_modifier_cat($_tmp, ".gif"))); ?>
