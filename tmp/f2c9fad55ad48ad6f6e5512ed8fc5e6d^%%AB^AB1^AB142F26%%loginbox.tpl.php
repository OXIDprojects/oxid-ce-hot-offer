...
">?</a></strong>
                ...
                <?php endif; ?>
                <p>
                    <button type="submit" class="submitButton"><?php echo smarty_function_oxmultilang(array('ident' => 'WIDGET_LOGINBOX_LOGIN'), $this);?>
</button>
                </p>
            </div>
