...
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxscript', 'widget/header/topcategories.tpl', 1, false),array('function', 'oxstyle', 'widget/header/topcategories.tpl', 3, false),array('function', 'oxmultilang', 'widget/header/topcategories.tpl', 13, false),array('function', 'oxgetseourl', 'widget/header/topcategories.tpl', 78, false),array('modifier', 'count', 'widget/header/topcategories.tpl', 15, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['ocont']->oxcontents__oxtitle->value; ?>
                            ...
                            <?php endforeach; endif; unset($_from); ?>
                            <?php if ($this->_tpl_vars['osubcat']->getIsVisible()): ?>
                                <li <?php if ($this->_tpl_vars['osubcat']->expanded): ?>class="current"<?php endif; ?> ><a <?php if ($this->_tpl_vars['osubcat']->expanded): ?>class="current"<?php endif; ?> href="<?php echo $this->_tpl_vars['osubcat']->getLink(); ?>
