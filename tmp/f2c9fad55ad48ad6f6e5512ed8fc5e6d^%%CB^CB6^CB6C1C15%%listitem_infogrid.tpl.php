...
smarty_core_load_plugins(array('plugins' => array(array('block', 'oxhasrights', 'widget/product/listitem_infogrid.tpl', 21, false),array('function', 'oxmultilang', 'widget/product/listitem_infogrid.tpl', 46, false),array('function', 'oxid_include_dynamic', 'widget/product/listitem_infogrid.tpl', 84, false),)), $this); ?>
...
">
                    <span itemprop="name"><?php echo $this->_tpl_vars['product']->oxarticles__oxtitle->value; ?>
</span>
                </a>
            </div>
                ...
                <div class="content">
                    ...
                    <?php endif; ?>
                        ...
                        <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'SHOWARTICLEPRICE')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                            <?php if ($this->_tpl_vars['product']->getFTPrice() > $this->_tpl_vars['product']->getFPrice()): ?>
 ...
 <?php echo $this->_tpl_vars['currency']->sign; ?>
                            ...
                            <?php endif; ?>
                                ...
                                <?php if ($this->_tpl_vars['product']->getFPrice()): ?>
                                    <span class="price"><span itemprop="price"><?php echo $this->_tpl_vars['product']->getFPrice(); ?>
