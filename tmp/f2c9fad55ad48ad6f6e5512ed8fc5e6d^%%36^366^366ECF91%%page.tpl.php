...
smarty_core_load_plugins(array('plugins' => array(array('block', 'oxifcontent', 'layout/page.tpl', 21, false),array('function', 'oxmultilang', 'layout/page.tpl', 22, false),)), $this); ?>
<?php ob_start(); ?>
...
unset($_smarty_tpl_vars);
 ?>
    <?php $this->_tag_stack[] = array('oxifcontent', array('ident' => 'oxdeliveryinfo','object' => 'oCont')); $_block_repeat=true;smarty_block_oxifcontent($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
        <div id="incVatMessage">*: <span class="deliveryInfo"><?php echo smarty_function_oxmultilang(array('ident' => 'WIDGET_PRODUCT_PRODUCT_PLUSSHIPPING'), $this);?>
<a href="<?php echo $this->_tpl_vars['oCont']->getLink(); ?>
" rel="nofollow"><?php echo smarty_function_oxmultilang(array('ident' => 'WIDGET_PRODUCT_PRODUCT_PLUSSHIPPING2'), $this);?>
</a></span></div>
