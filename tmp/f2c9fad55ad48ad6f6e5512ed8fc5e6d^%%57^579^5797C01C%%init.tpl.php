<?php /* Smarty version 2.6.26, created on 2012-04-12 10:01:47
         compiled from widget/facebook/init.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxscript', 'widget/facebook/init.tpl', 3, false),array('function', 'oxmultilang', 'widget/facebook/init.tpl', 8, false),array('modifier', 'oxmultilangassign', 'widget/facebook/init.tpl', 15, false),array('modifier', 'oxaddparams', 'widget/facebook/init.tpl', 16, false),)), $this); ?>
<?php if ($this->_tpl_vars['oViewConf']->getFbAppId()): ?>
    <div id="fb-root"></div>
    <?php echo smarty_function_oxscript(array('include' => "js/widgets/oxfacebook.js"), $this);?>

    <?php if (! $this->_tpl_vars['oView']->isFbWidgetWisible()): ?>
